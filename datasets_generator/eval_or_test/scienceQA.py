# source_paths
sqa_test_images_path = '/home/atuin/b211dd/b211dd19/data/dataset/tinyllava/train/raw/scienceQA/test'
...
path2save_json = '/home/atuin/b211dd/b211dd19/data/dataset/tinyllava/eval/text_files_small_dataset/scienceQA_test.json'

prefix_path_img = "scienceQA/test/"
...
for idx, sample in tqdm(test_data.items()):
    ...
    if img_file_name == None:
        count_test_none_img += 1
        continue

    sample_path = os.path.join(sqa_test_images_path, idx)
    ...
    shutil.copy2(img_path,
                 os.path.join(dir2save_img, prefix_path_img+idx+".png"))


with open(path2save_json, 'w') as outfile:
    json.dump(test_list, outfile, indent=4)

print(f"There are {count_test_none_img} samples without image in test set!")
print(f"{len(test_list)} test samples with image")
