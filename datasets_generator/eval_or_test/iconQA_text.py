...
path2save_json = '/home/atuin/b211dd/b211dd19/data/dataset/tinyllava/eval/text_files_small_dataset/iconQA_text_test.json'

prefix_path_img = "iconQA_text/test/"
...
test_text_root = os.path.join(test_root, 'choose_txt')

test_dir_names = os.listdir(test_text_root)
...
for dir_name in tqdm(test_dir_names):
    sample_path = os.path.join(test_text_root, dir_name)
