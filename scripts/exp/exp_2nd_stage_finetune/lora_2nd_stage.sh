...
TUNE_TYPE_LLM=lora
OUTPUT_DIR=/home/hk-project-starter-p0022188/tum_piz8108/data/checkpoints/llava_factory/two_stage_pretrain/tiny-llava-phi-2-siglip-so400m-patch14-384-base-pretrain-lora-r4
RUN_NAME=tiny-llava-phi-2-siglip-so400m-patch14-384-base-pretrain-lora-r4
