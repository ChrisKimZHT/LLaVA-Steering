...
from typing import Dict, Optional, Union, List, Sequence, TYPE_CHECKING
import transformers
...
def init_mores_pos_configs(
    ...
    return {
        ...
        "mores_share_weights": mores_share_weights,
        "intervened_prompt_part": intervened_prompt_part,
        "intervene_modality": intervene_modality,
...
class TrainingArguments(transformers.TrainingArguments):
    ...
    tune_type_llm: str = field(default="frozen") # support only: frozen, full, lora, qlora_int4, qlora_int8, mores
    tune_type_vision_tower: str = field(default="frozen") # support only: frozen, full, partially-tune, mores
    ...
    # mores configs
    mores_config_path: str = field(default="none")
    intervened_prompt_part: Optional[str] = None
    mores_pos_configs = None
    intervene_include_img_embed: Optional[bool] = None

    intervention_positions: Optional[str] = None
    mores_share_weights: Optional[bool] = None
    intervene_modality: Optional[str] = None   # vis text

    intervention_positions_2: Optional[str] = None
    mores_share_weights_2: Optional[bool] = None
    intervene_modality_2: Optional[str] = None   # vis text
   
    # extra added configs
    epoch_to_save: int = 1

    # adapter
    adapter_bottleneck_size: int = 256
    adapter_dropout: float = 0.05
    adapter_use_parallel_adapter: bool = False
    adapter_use_adapterp: bool = False
