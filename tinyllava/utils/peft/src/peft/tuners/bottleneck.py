...
TRANSFORMERS_MODELS_TO_ADAPTER_TYPE_MAPPING = {
    ...
    "phi": {"fc1": "mh_adapter", "fc2":"output_adapter"},
    "opt": {"fc1":"mh_adapter", "fc2":"output_adapter"},
    "chatglm": {"dense_h_to_4h": "mh_adapter", "dense_4h_to_h": "output_adapter"},
    "llava":{"gate_proj": "mh_adapter", "up_proj":"mh_adapter", "down_proj":"output_adapter"},
    "instructblip": {"gate_proj": "mh_adapter", "up_proj":"mh_adapter", "down_proj":"output_adapter"},
}
