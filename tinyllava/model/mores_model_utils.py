...
MODEL_TYPE_TO_ARGS_ADAPT_MAPPING = {
    ...
    'vicuna': adapt_language_model_args_without_cache_pos,
}
...
MODEL_TYPE_TO_ARGS_ADAPT_MAPPING_FOR_GENERATE = {
    ...
    'vicuna': adapt_llm_generate_args
}

class MoReSModelProxy:
    # This is used in MoReSModel to filter args the model needs
...
class MoReSModelProxy4Generate:
    # This is used in MoReSModel to filter args the model needs when calling MoReSModelShell.generate()
    def __init__(self, model_register_name):
        # self.model = model
        self.model_register_name = model_register_name
