...
def mores_state(training_arguments):
    train_with_mores = hasattr(training_arguments, 'training_recipe') and training_arguments.training_recipe == "mores"
    pretrained_mores = hasattr(training_arguments, 'pretrained_model_path') and training_arguments.pretrained_model_path and "mores" in os.listdir(training_arguments.pretrained_model_path)
    return train_with_mores, pretrained_mores
...
def train():
    ...
    # mores
    train_with_mores, pretrained_mores = mores_state(training_arguments)
    if train_with_mores and not pretrained_mores:
        model.add_mores_adaptor_from_training_arguments(training_arguments)
    elif train_with_mores and pretrained_mores:
        model.load_mores_adaptor_from_ckpt(training_arguments.pretrained_model_path)
    ...
    if train_with_mores and hasattr(model, 'mores_pos_configs') and model.mores_pos_configs:
        data_arguments.mores_pos_configs = model.mores_pos_configs
