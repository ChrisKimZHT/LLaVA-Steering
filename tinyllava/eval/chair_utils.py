...
class CHAIR(object):
    ...
    def get_annotations_from_segments(self):
        ...
        for i, annotation in tqdm.tqdm(enumerate(segment_annotations)):
    ...
    def get_annotations_from_captions(self):
        ...
        for i, annotation in tqdm.tqdm(enumerate(caption_annotations)):
...
if __name__ == '__main__':
    ...
    parser.add_argument("--cap_file", type=str, default='/home/atuin/b211dd/b211dd19/data/dataset/tinyllava/eval/eval_tinyllava/CHAIR/answers/test1.jsonl',
    ...
    parser.add_argument("--coco_path", type=str, default='/home/atuin/b211dd/b211dd19/data/dataset/tinyllava/eval/eval_tinyllava/CHAIR/annotations',
                        help="only use for regenerating CHAIR evaluator object, will be ignored if uses cached evaluator.")
    
    parser.add_argument("--save_path", type=str, default="temp_save",
