...
def evaluate_by_chatgpt(data, output_entry, correctness_entry, api_key, gpt_model="gpt-4", load_json=False, save_json_path="./hallusion_output.json"):
...
def check_same_by_chatgpt(data, output_entry, api_key, gpt_model="gpt-4", load_json=False, save_json_path="./hallusion_output.json"):
